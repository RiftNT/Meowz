...
class _FeedScreenState extends State<FeedScreen> {
                ...
                children: [
                  AppinioSwiper(
                    ...
                    onSwipeEnd: (previousIndex, targetIndex, activity) {
                      _swipeEnd(previousIndex, targetIndex, activity, _catsList);
                    },
                    onEnd: _onEnd,
                  ...
                  Padding(
                    ...
                    child: FloatingActionButton(
                      ...
                      child: Icon(_showDetails ? Icons.arrow_upward : Icons.arrow_downward),
                    ),
                  ),
                ],
              ),
  ...
  void _swipeEnd(int previousIndex, int targetIndex, SwiperActivity activity, List<Cat> cats) {
